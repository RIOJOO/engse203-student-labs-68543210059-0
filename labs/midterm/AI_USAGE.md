...
|13.21|b2.3 |2.3 ทำงานร่วมกับตัวกรองสถานะ | แก้ไขโค้ดตัวกรองสถานะ เพ่ิมที่ต้องผ่านเงื่อนไข 2 เงื่อนไข |
|13.38|b2.4 |ปรับให้ค้นแล้วไม่เจอ แสดง ไม่พบ ~~~ ทำให้แผงสรุปยังนับข้อมูลทั้งหมด 5 3 1 1 | แก้ไขโค้ดให้ตรงตามเงื่อนไข |
|13.50|b3.1 |เพิ่มปุ่มทำเสร็จ | เพิ่มโค้ดเข้ามา |
|14.10|b3.2 |ทำให้สถานะเปลี่ยนตอนกดแล้ว |ทำการแก้ไขโค้ด ตัว requestlist ให้มันขึ้นสถานะ completed |
|14.30|b4.1|สร้างไฟล์ priorityBadge.jsx | ไม่ได้ใช้ AI |
|14.50|b4.2|ทำให้ priorityBadge เป็นค่าอื่น | Ai ให้โค้ดมา |
